...
export function FilterBottomSheet({
 ...
 <Text className="text-sm text-muted-foreground">
 Đang tải danh mục, trang trại và chứng nhận…
 </Text>
 </View>
 ) : null}
 ...
 <Pressable
 accessibilityRole="button"
 onPress={onRetryFacets}
 className="self-start rounded-lg border border-border px-3 py-2 active:opacity-80"
 >
