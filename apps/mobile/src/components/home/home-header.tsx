...
function HeaderIcon({
  ...
  return (
    <Pressable
      ...
      onPress={onPress}
      className="relative h-11 w-11 items-center justify-center rounded-full active:bg-[#F2F6F3]"
    >
  ...
  return (
    <View className="gap-2">
      ...
      >
        ...
        <View>
          <Text className="text-[12px] font-medium text-[#5F6C64]">Giao đến</Text>
          <View className="flex-row items-center gap-1">
            <Text className="text-[16px] font-bold text-[#234234]">{location}</Text>
