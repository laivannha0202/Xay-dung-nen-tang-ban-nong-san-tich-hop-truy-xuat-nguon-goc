...
function KetQuaTruyXuat({ ma }: { ma: string }) {
 ...
 Lô hiện không có thông báo thu hồi công khai từ hệ thống.
 </Text>
 </View>
 )}
 ...
 description="hệ thống chưa có sự kiện công khai cho mã truy xuất này."
 />
 )}
 </View>
 </View>
...
export default function TrangTruyXuatChiTiet() {
 ...
 <Text className="text-sm leading-5 text-muted-foreground">
 Batch, farm, certificate, timeline và cảnh báo thu hồi từ dữ liệu công khai của hệ thống.
 </Text>
