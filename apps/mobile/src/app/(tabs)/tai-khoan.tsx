...
export default function TrangTaiKhoan() {
 ...
 Alert.alert(
 'Đăng xuất?',
 'Phiên đăng nhập và dữ liệu cache tài khoản trên thiết bị sẽ được dọn.',
 [
 ...
 Một nơi cho hồ sơ, địa chỉ và các dữ liệu cá nhân đã đồng bộ hệ thống.
 </Text>
 </View>
 ...
 <Badge variant="success">Đã đồng bộ hệ thống</Badge>
 ...
 description="Xem wishlist hệ thống và bỏ sản phẩm khỏi danh sách."
 ...
 <MucTaiKhoan
 title="Thông báo đẩy"
 description="Quản lý quyền thông báo và mở nhanh nội dung liên quan."
 ...
 <Badge variant="info"> – Cart Sync Test</Badge>
 <Text className="text-sm leading-5 text-muted-foreground">
 ...
 className={[
 'min-h-12 items-center justify-center rounded-2xl border border-danger px-4 py-3',
