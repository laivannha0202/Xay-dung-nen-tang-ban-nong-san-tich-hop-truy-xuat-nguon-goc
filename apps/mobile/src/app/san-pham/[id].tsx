...
export default function TrangChiTietSanPham() {
 ...
 setCtaMessage('Đã thêm vào giỏ và đồng bộ với hệ thống.');
 },
 onError: () => {
 ...
 useEffect(() => {
 if (trangThaiXacThuc !== 'da-dang-nhap' || !id || themGioHangMutation.isPending) {
 return;
 }
 ...
 if (!pendingAction || pendingAction.loai !== 'them-gio-hang') {
 return;
 }
 ...
 description="hệ thống chưa trả biến thể có thể bán cho sản phẩm này."
 />
 )}
 </Section>
 ...
 Tồn do hệ thống tính từ InventoryLot hợp lệ; Mobile không tự suy diễn FEFO hoặc
 reservation.
 </Text>
 </View>
 </Section>
 ...
 description="hệ thống chưa trả dữ liệu thu hoạch gần nhất cho trang trại này."
 />
 )}
 </Section>
 ...
 description="Sản phẩm chưa có chứng nhận được hệ thống công khai."
 />
 )}
 </Section>
 ...
 description="hệ thống chưa trả sản phẩm liên quan cho danh mục này."
 />
 )}
 </Section>
 </ScrollView>
