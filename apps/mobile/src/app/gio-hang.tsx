...
export default function TrangGioHang() {
 ...
 <Text className="text-sm leading-5 text-muted-foreground">
 Không thể áp dụng thay đổi. Hãy cập nhật lại để lấy giá và tồn kho hiện tại.
 </Text>
 </View>
 ) : null}
 ...
 <Text className="text-sm leading-5 text-muted-foreground">
 Giá, ưu đãi, phí vận chuyển và tổng thanh toán sẽ được cập nhật trước khi bạn xác nhận.
 </Text>
 <Pressable
 accessibilityRole="button"
